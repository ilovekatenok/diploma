...
<asm name="0">
	<cp>
		...
		<constant value="A.__matchSynthesisAttributes2AMNElement():V"/>
		...
		<constant value="SynthesisAttributes2AMNElement"/>
		<constant value="A.__applySynthesisAttributes2AMNElement(NTransientLink;):V"/>
		...
		<constant value="22:4-22:37"/>
		<constant value="25:8-25:27"/>
